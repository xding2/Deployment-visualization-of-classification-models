...
(function($){
    "use strict";
    var autoplay, bgcolor, blocknum, blocktitle, border, core, container, content, dest, extraassets/css/,
        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                obj.on('click', function(e){
                    ...
                    extraassets/css/ = obj.data( 'assets/css/' ) || '';
                    ...
                    core = '<div class="vbox-overlay ' + extraassets/css/ + '" style="background:'+ overlayColor +'">'+
                    preloader + '<div class="vbox-container"><div class="vbox-content"></div></div>' + vbheader + navigation + '</div>';

                    $('body').append(core).addClass('vbox-open');

                    $('.vbox-preloader div:not(.sk-circle) .sk-child, .vbox-preloader .sk-rotating-plane, .vbox-preloader .sk-rect, .vbox-preloader div:not(.sk-folding-cube) .sk-cube, .vbox-preloader .sk-spinner-pulse').assets/css/('background-color', option.spinColor);
                    ...
                    blocktitle.assets/css/(option.titlePosition, '-1px');
                    blocktitle.assets/css/({
                      'color' : option.titleColor,
                      'background-color' : option.titleBackground
                    });

                    $('.vbox-close').assets/css/({
                      'color' : option.closeColor,
                      'background-color' : option.closeBackground
                    });

                    $('.vbox-num').assets/css/(option.numerationPosition, '-1px');
                    $('.vbox-num').assets/css/({
                      'color' : option.numerationColor,
                      'background-color' : option.numerationBackground
                    });

                    $('.vbox-next span, .vbox-prev span').assets/css/({
                      'border-top-color' : option.arrowsColor,
                      'border-right-color' : option.arrowsColor
                    });

                    content.html('');
                    content.assets/css/('opacity', '0');
                    overlay.assets/css/('opacity', '0');
                ...
                function checknav(){
                    ...
                    if (!thenext.length && infinigall !== true) {
                      $('.vbox-next').assets/css/('display', 'none');
                      nextok = false;
                    } else {
                      $('.vbox-next').assets/css/('display', 'block');
                      nextok = true;
                    }

                    if (items.index(obj) > 0 || infinigall === true) {
                      $('.vbox-prev').assets/css/('display', 'block');
                      prevok = true;
                    } else {
                      $('.vbox-prev').assets/css/('display', 'none');
                      prevok = false;
                    }
                    // activate swipe
                ...
                function navigateGall(destination) {
                    ...
                    content.animate({
                      ...
                      overlay.assets/css/('background',overlayColor);

                      content
                      .removeClass('vbox-animated')
                      .removeClass('swipe-left')
                      .removeClass('swipe-right')
                      .assets/css/({'margin-left': 0,'margin-right': 0});
                ...
                function onMoveEvent(e){
                    if (startouch === true) {
                        ...
                        if ((absdiffX > absdiffY) && (absdiffX <= 100)) {
                            e.preventDefault();
                            content.assets/css/('margin-left', diffX);
                        }
                    }
                }
                ...
                function onUpEvent(e){
                    if (startouch === true) {
                        ...
                        if (Math.abs(diff) >= threshold && change === true) {
                            ...
                            content.assets/css/({'margin-left': 0,'margin-right': 0});
                        }
                    }
                }
                ...
                */
                ...
                function updateoverlay(){
                    ...
                    content.find(">:first-child").addClass('vbox-figlio').assets/css/({
                        'width': framewidth,
                        'height': frameheight,
                        'padding': border,
                        'background': bgcolor
                ...
                function updateOL(){
                    ...
                    content.assets/css/('margin-top', margine);
                    content.assets/css/('margin-bottom', margine);
